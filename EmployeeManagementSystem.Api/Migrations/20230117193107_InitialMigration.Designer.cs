...
namespace EmployeeManagementSystem.Api.Migrations
{
    ...
    [Migration("20230117193107_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeManagementSystem.Shared.Domain.Country", b =>
                {
            ...
            modelBuilder.Entity("EmployeeManagementSystem.Shared.Domain.Employee", b =>
                {
            ...
            modelBuilder.Entity("EmployeeManagementSystem.Shared.Domain.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagementSystem.Shared.Domain.Employee", b =>
                {
                    b.HasOne("EmployeeManagementSystem.Shared.Domain.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EmployeeManagementSystem.Shared.Domain.JobCategory", "JobCategory")
                        .WithMany()
